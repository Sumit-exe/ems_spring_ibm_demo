...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public List<Employee> getAllEmployees() {
		...
		if (empList.isEmpty()) {
			String errorMessage = "No Employees are found!";
	...
	public Employee updateEmployee(Employee employee) {
		LOG.info(employee.toString());
		Employee empToBeUpdated = this.getEmployeeById(employee.getEid());
		...
		if (empToBeUpdated != null) {
			...
			empToBeUpdated.setAge(employee.getAge());
			return employeeRepository.save(empToBeUpdated);
		} else {
			// Handle case where employee with the given ID is not found
			throw new EmployeeNotFoundException("Employee with ID " + employee.getEid() + " not found.");
		}
	}
	...
	public Employee deleteEmployee(String employeeId) {
		...
		if (empToBeDeleted == null) {
			String errorMessage = "Employee with employeeId" + employeeId + " is not found!";
			LOG.warn(errorMessage);
			throw new EmployeeNotFoundException(errorMessage);
		} else {
			employeeRepository.deleteById(employeeId);
			LOG.info("Employee with EmployeeId" + employeeId + " is Deleted");
