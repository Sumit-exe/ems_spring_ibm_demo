...
public class EmployeeController {
	...
	@PostMapping("add-emp")
	public ResponseEntity<com.ibm.springboot.demo.Employee> addEmp(@RequestBody Employee employee) {
	...
	public ResponseEntity<Employee> UpdateEmp(@RequestBody Employee employee) {
		Employee empToBeUpdated = employeeService.updateEmployee(employee);
		HttpStatus status = HttpStatus.CREATED;
		HttpHeaders headers = new HttpHeaders();
	...
	public ResponseEntity<com.ibm.springboot.demo.Employee> deleteEmployee(@PathVariable(name = "eid") String employeeId) {
